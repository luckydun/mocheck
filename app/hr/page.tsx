...
export default function HRDashboard() {
  ...
  useEffect(() => {
    ...
    const name = localStorage.getItem('firstName') || 'HR';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-gray-600 mt-2">HR Dashboard • Geo-Location Attendance & Billing System</p>
          </div>
          <button
            onClick={logout}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">Add, Edit, View & Remove employees • Set Net Salary</p>
          ...
          >
            ...
            <p className="text-gray-600 mb-8">View who is currently signed in with geo & selfie</p>
        ...
        <div className="mt-12 text-center text-sm text-gray-500">
          Note: HR cannot promote other employees to HR role (Admin only)
        </div>
      </div>
    </div>
  );
